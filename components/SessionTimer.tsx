...
function computeState(): TimerState {
  ...
  if (totalSecs >= OPEN && totalSecs < MID) {
    ...
    return { phase: 'orb_window', label: '🔴 LIVE — OPENING RANGE BUILDING', sublabel: 'OR closes at 10:00 AM ET (7:00 PM Dubai) — wait for the range to form', hours: 0, minutes: t.m, seconds: t.s, color: 'var(--red)', bgColor: 'var(--red-bg)', borderColor: 'var(--red-border)', nyTime, dubaiTime, dayLabel: dayNames[day], progressPct: pct }
  }
  ...
  if (totalSecs >= MID && totalSecs < CLOSE) {
    ...
    return { phase: 'post_orb', label: '🟢 LIVE — OR COMPLETE · TRADE WINDOW OPEN', sublabel: 'Session closes at 10:30 AM ET (7:30 PM Dubai)', hours: 0, minutes: t.m, seconds: t.s, color: 'var(--green)', bgColor: 'var(--green-bg)', borderColor: 'var(--green-border)', nyTime, dubaiTime, dayLabel: dayNames[day], progressPct: pct }
  }
